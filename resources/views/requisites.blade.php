   ...
   <body class="bg-light text-dark">
               ...
               <ul class="navbar-nav ml-auto">
                  ...
                  <li class="nav-item dropdown indent-to-the-right indenting-text active">
                     ...
                     <div class="dropdown-menu" aria-labelledby="dropdown01">
                        ...
                        <a class="dropdown-item active" href="/requisites">Реквизиты</a>
                     </div>
                  </li>
      ...
      <div class="mt-5 p-5 container marketing">
         <div class="col-md-9 col-sm-12 col-xs-12 content-md">
            <p>Ниже приведены реквизиты организации.</p>
            <table class="table table-striped">
               <tbody>
                  <tr>
                     <td>Полное наименование:</td>
                     <td>Общество с ограниченной ответственностью «Стоматологическая клиника «32»»</td>
                  </tr>
                  <tr>
                     <td>Сокращенное наименование:</td>
                     <td>ООО «Стоматологическая клиника «32»»</td>
                  </tr>
                  <tr>
                     <td>ИНН/КПП:</td>
                     <td>7438026686/743801001</td>
                  </tr>
                  <tr>
                     <td>ОРГН:</td>
                     <td>1097438000109</td>
                  ...
                  <tr>
                     <td>Юридический и фактически адрес:</td>
                     <td>456513 Россия Челябинская обл., Сосновский район, п.Рощино, ул. Ленина, 5а пом.№1 и №4</td>
                  </tr>
                  <tr>
                     <td>Телефон, факс:</td>
                     <td>8(351) 750-51-54</td>
                  </tr>
                  <tr>
                     <td>Электронная почта:</td>
                     <td>dentistry@mail.ru</td>
                  </tr>
                  <tr>
                     <td>Сайт:</td>
                     <td><a href="https://dentistry.ru/" target="_blank">https://dentistry.ru/</a></td>
                  </tr>
                  <tr>
                     <td>Банковские реквизиты:</td>
                     <td>р/с 40702810907180008075 в ПАО «ЧЕЛИНДБАНК» г. Челябинск<br>
                        Бик - 047501711<br>
                  ...
                  <tr>
                     <td>Лицензия:</td>
                     <td>№ ЛО-74-01-001495 от 29 марта 2012 г.</td>
                  </tr>
               </tbody>
            </table>
         </div>
         ...
         <div class="modal-dialog" role="document">
            <div class="modal-content">
               ...
               <div class="modal-body">
                  <form action="/requisites/store" method="POST">
                     @csrf
                     <div class="card-body">
