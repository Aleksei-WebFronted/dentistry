...
<html lang="en">
   ...
   <body class="bg-light text-dark">
               ...
               <ul class="navbar-nav ml-auto">
                  ...
                  <li class="nav-item dropdown indent-to-the-right indenting-text active">
                     ...
                     <div class="dropdown-menu" aria-labelledby="dropdown01">
                        ...
                        <a class="dropdown-item active" href="/healomc">Лечение по ОМС</a>
      ...
      <!-- Server -->
      <div class="mt-5 container marketing p-4">
         <h1>Лечение по ОМС</h1>
         <div class="col-md-9 col-sm-12 col-xs-12 content-md">
            <p>Бытует мнение, что частные стоматологические клиники не предоставляют услуги по обязательному медицинскому страхованию. Однако это не совсем так: любая стоматологическая клиника может заключить соответствующий договор и принимать участие в системе ОМС.</p>
            <p>Наша стоматологическая клиника «32» в Челябинске является участником ОМС.</p>
            <p><strong>Вы можете получить целый ряд стоматологических услуг по соответствующему полису:</strong></p>
            <ul>
               <li>профессиональная гигиена полости рта</li>
               <li>лечение кариеса (после консультации врача)</li>
            </ul>
            <p><strong>Для этого вам необходимо иметь при себе следующие документы:</strong></p>
            <ol>
            ...
            <p>Все подробности по телефону:&nbsp;+7 (351) 242-02-16</p>
            <p>Жителям Челябинской области доступны электронные услуги в сфере ОМС.&nbsp;</p>
            <p>Посмотрите буклет о полисе обязательного медицинского страхования (нажмите на рисунок для увеличения):</p>
            <p class="col-12" style="text-align: center;"><img class="w-100" src="https://neodenta.ru/upload/oms/page1_small.jpg" alt="Буклет по ОМС, страница 1" ></p>
            <p class="col-12" style="text-align: center;"><img class="w-100" src="https://neodenta.ru/upload/oms/page2_small.jpg" alt="Буклет по ОМС, страница 2"></p>
            <p class="col-12"><iframe class="w-100" src="https://www.youtube.com/embed/TllsBMGd6H0" frameborder="0" style="aspect-ratio: 16 / 9"></iframe></p>
            <p class="col-12"><iframe class="w-100" src="https://www.youtube.com/embed/z-VQ9L5lqYs" frameborder="0" style="aspect-ratio: 16 / 9"></iframe></p>
            <p class="col-12"><iframe class="w-100" src="https://www.youtube.com/embed/A3Who_cG4Ug" frameborder="0" style="aspect-ratio: 16 / 9"></iframe></p>
         </div>
      </div>
      </div>
      <!-- Modal -->
