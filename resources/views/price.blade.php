...
<html lang="en">
   ...
   <body class="bg-light text-dark">
         ...
         <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
               <ul class="navbar-nav ml-auto">
                  ...
                  <li class="nav-item active"> <a class="nav-link" href="/price">Цены</a> </li>
      ...
      <div class="card bg-dark text-primary">
         <img src="https://luberdent.ru/wp-content/uploads/2020/05/ceny_ban-1.png" class="card-img" alt="Цены">
         <div class="thumbnail-text ml-5">
            <h1 class="ml-5">Цены</h1>
         </div>
      </div>
      ...
      <div class="container">
        ...
        <div class="row mt-5 mb-3">
            <div class="col-6"> 
         <h3><span class="mt-2 mb-2 pb-2 badge badge-pill badge-info">Наши услуги</span></h3>
            </div>
            <div class="col-6"> 
            <a class="btn btn-link pull-right" href="/price.txt" download>Скачать</a>
            </div>
         </div>
         <table class="table">
            <thead>
