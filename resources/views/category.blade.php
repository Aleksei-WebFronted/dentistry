...
<html lang="en">
   ...
   <body class="bg-light text-dark">
         ...
         <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
               <ul class="navbar-nav ml-auto">
                  ...
                  <li class="nav-item active"> <a class="nav-link" href="/category">Отзывы</a> </li>
      ...
      <div class="card bg-dark text-primary mt-5">
         <img src="https://luberdent.ru/wp-content/uploads/2020/05/reviews_bg-1.png" class="card-img" alt="">
         <div class="thumbnail-text ml-5">
            <h1 class="ml-5">Отзывы</h1>
         </div>
      </div>
      ...
      <div class="mt-5 container marketing">
         <form action="/category" method="POST">
            ...
            <div class="card-body">
               <div class="form-group">
                  ...
                  <input type="text" name="title" class="form-control" id="exampleInputEmail1" placeholder="Имя клиента" required>
               </div>
               <div class="form-group">
                  <label for="exampleInputPassword1">Сообщение</label>
                  <input type="text" name="job" class="form-control" id="exampleInputPassword1" placeholder="Ваше сообщение"required>
               </div>
               <!-- /.card-body -->
         ...
         <span class="position mb-2">{{ $category->job }}</span>
         <br>
         </div>
         <br>
         @endforeach
